...
<body>
    <header class="cabfoot">
        <img style="align-content: center" src="{{ asset('img/ESCUDO2.jpg')}}" alt="Escudo Nacional de Bolivia" width="100" height="100">
    ...
    <section>
        <table style="border: 1">
            <tr>
                ...
                <td style="text-transform: uppercase"><b>{{$nombre}}</b></td>
                <td style="width: 15%">Cedula de Identidad:</td>
                <td style="text-transform: uppercase"><b>1069691 - 1R</b></td>
            </tr>
            <tr>
                <td style="width: 15%">Cargo Actual:</td>
                <td style="text-transform: uppercase"><b>Profesional III</b></td>
        ...
        <div style="background-color: rgb(179, 195, 231)">
    ...
    <footer>
        ...
        <p class="cabfoot"><small>www.planificacion.gob.bo<br>Av. Mariscal Santa Cruz Esq. Calle Oruro Edif. #1092, Ex Edificio Comibol, Teléfono Fax: (591-2) 2189000</small></p>
